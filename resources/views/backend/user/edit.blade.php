        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                    <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('user.edit_user') }}</h4>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{route('users.update')}}"  method="POST" enctype="multipart/form-data" id="basicform">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        " name="mobile" placeholder="{{ __('levels.enter_mobile_number') }}" value="{{ old('mobile',$user->mobile) }}" id="phone" autocomplete="off">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group pt-1">
                                    <label for="input-select">{{ __('parcel.per_hour_salary') }}</label>
                                    <input type="text" class="form-control" placeholder="{{ __('parcel.per_hour_salary') }}" name="per_hour_salary" value="{{ old('per_hour_salary',$user->per_hour_salary) }}" />
