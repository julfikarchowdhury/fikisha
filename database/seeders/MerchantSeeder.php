...
class MerchantSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $merchantUser->first_name      = "Riaz";
        $merchantUser->last_name       = "Uddin";
        $merchantUser->mobile          = "01912938003";
        $merchantUser->email           = "merchant@fikisha.com";
        ...
        $merchantUser->province_id     = 1;
        $merchantUser->city_id         = 1;
        ...
        $merchant->business_name       = "Fikisha";
