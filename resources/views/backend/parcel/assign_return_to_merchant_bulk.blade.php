      ...
      <div class="modal-content" id="data-modal">
        ...
        <form action="{{ route('parcel.assign-return-to-merchant-bulk',['page'=>$request->page]) }}" method="post">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group  ">
                            ...
                            <div class="form-control-wrap deliveryman-search">
                                <select id="return_todeliveryman_bulk" class="form-control delivery_man_search_hub_multiple_parcel_return" name="delivery_man_id" data-url="{{ route('parcel.deliveryman.search') }}" >
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" id="assign_return_merchant_btn" >{{ __('levels.save') }}</button>
                <button type="submit" class="btn btn-primary" data-bs-dismiss="modal">{{ __('levels.cancel') }}</button>
            </div>
        </form>
    </div>
</div>
