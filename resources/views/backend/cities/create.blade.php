                ...
                <div class="card-body">
                    ...
                    <form action="{{route('cities.store')}}"  method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input id="portal_code" type="text" name="portal_code" placeholder="{{ __('parcel.portal_code') }}" autocomplete="off" class="form-control @error('portal_code') is-invalid @enderror" value="{{ old('portal_code') }}" required>
                            @error('portal_code')
                                <small class="text-danger mt-2">{{ $message }}</small>
                            @enderror
                        </div>
