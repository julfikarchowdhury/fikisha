                ...
                <div class="col-lg-3 col-sm-6  mb-3 text-center ">
                    <div class="service-item p-3 h-100"> 
                        <div class="service-item-box d-block">
                            ...
                            <p class="mb-2">{!! \Str::limit(strip_tags($service->description), 120, ' ...<p><a href="'.route('service.details',$service->id).'" class="text-secondary"><i class="fa fa-arrow-right"></i></a></p>') !!}</p>  
                        </div>
                    </div>
                </div>  
            @endforeach
