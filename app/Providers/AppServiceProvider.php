...
use App\Repositories\DutySchedule\DutyScheduleRepository;
...
use App\Repositories\FrontWeb\Slider\SliderRepository;
...
use App\Repositories\LeaveAssign\LeaveAssignRepository;
...
use App\Repositories\ParcelCategory\ParcelCategoryRepository;
use App\Repositories\Province\ProvinceInterface;
use App\Repositories\Province\ProvinceRepository;
use App\Repositories\SenderCustomer\SenderCustomerInterface;
use App\Repositories\SenderCustomer\SenderCustomerRepository;
use App\Repositories\ShippingType\ShippingTypeInterface;
use App\Repositories\ShippingType\ShippingTypeRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(ShippingTypeInterface::class, ShippingTypeRepository::class);
        ...
        $this->app->bind(SenderCustomerInterface::class,    SenderCustomerRepository::class);
        $this->app->bind(ProvinceInterface::class,          ProvinceRepository::class);
    }
    ...
    public function boot(): void
    {
        ...
        if (Schema::hasTable('settings') && Schema::hasTable('merchants') && env('APP_INSTALLED')):
            merchantPaymentNotification();
        endif;
    }
}
