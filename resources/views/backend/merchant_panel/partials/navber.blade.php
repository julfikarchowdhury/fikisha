                                ...
                                <ul class="navbar-nav ml-auto navbar-right-top merchant-mobile-navbar-nav">
                                    ...
                                    <li class="nav-item"> 
                                        <div class="currentLocation">
                                            <div id="autocomplete-container" class="form-group random-search text-dark mb-0 mt-2">
                                                Current Location: <span id="autocomplete-input"></span>
                                                <a href="javascript:void(0)" class="submit-btn btn current-location"
                                                    id="locationIcon" onclick="getLocation()" style="z-index:99999999!important">
                                    ...
                                    @if (!empty(auth()->user()->email_verified_at) && !empty(auth()->user()->mobile_verified_at) && auth()->user()->status == 1)
                                        <li class="nav-item lang">
                                            <a class="nav-link " href="{{route('merchant.panel.analytics')}}"> {{ __('parcel.analytics') }}</a>
                                        </li>
                                        <li class="nav-item lang">
                                            <a class=" btn btn-sm btn-primary mt-2" href="{{ route('merchant-panel.parcel.create', ['fresh' => 1]) }}"><i class="fa fa-plus"></i> {{ __('levels.create') }} {{ __('parcel.parcel') }}</a>
                                        </li>
                                        <li class="nav-item lang">
                                            <div class="form-group col-12 pt-1">
                                                <div class="dropdown lang-dropdown  changeLocale ">
                                    ...
                                    <li class="nav-item dropdown nav-user navbar_menus">
                                        <a class="dropdown-item {{ (request()->is('dashboard*')) ? 'active' : '' }}" href="{{ route('dashboard.index') }}"><i class="fa fa-home"></i> {{ __('dashboard.title') }}</a>
                                    </li>
                                    ...
                                    <li class="nav-item dropdown nav-user d-lg-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                            ...
                                            <a class="dropdown-item" href="{{route('merchant-profile.index')}}"><i class="fas fa-user mr-2"></i>{{ __('menus.profile') }}</a>
                                            ...
                                            <a class="dropdown-item" href="{{route('merchant-password.change')}}"><i class="fas fa-key mr-2"></i>{{ __('menus.change_password') }}</a>
        ...
        <div class="navbar-other w-100 d-flex  justify-content-between">
            <div >
                <a href="{{ route('dashboard.index') }}">
                    <img src="{{ settings()->logo_image }}" style="margin-top: 10px;height:50px!important;object-fit:contain" width="150" alt="Logo">
                </a>
            </div>
