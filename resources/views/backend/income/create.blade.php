        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                    <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('income.create_income') }}</h4>
                </div>
                <div class="card-body">
                    <!-- <h2 class="pageheader-title">{{ __('income.create_income') }}</h2> -->
                    <form action="{{route('income.store')}}"  method="POST" enctype="multipart/form-data" id="basicform">
                        @csrf
                        <div class="row">
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group" id="head_title" style="@if($errors->has('title')) display:block @else display:none @endif">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group merchant_search  " id="user_head">
                                ...
                                <div class="form-group amount_divs">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="number" class="form-control cash-collection" id="amount" step="any" value="{{ old('amount') }}" name="amount" placeholder="{{ __('placeholder.Enter_Amount') }}" required>
                                        @error('amount')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                        @enderror
