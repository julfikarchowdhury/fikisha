        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                    <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('user.create_user') }}</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group pt-1">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ __('parcel.per_hour_salary') }}" name="per_hour_salary" value="{{ old('per_hour_salary') }}" />
