                ...
                <div class="col-lg-5">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('customer.otp-verification') }}">
                            @csrf
                            <p class="text-center">
                                We have sent you a 6 digit OTP. Please verify your contact:
                                <br>
                                <strong>{{ session('merchant_signup_contact') }}</strong>
                            </p>
                        ...
                        <form id="resend" method="POST" action="{{route('customer.resend-otp')}}">
                            @csrf
