...
return [
    ...
    //account heads
    'Payment received from Merchant'    => 'Payment received from sender',
    'Cash received from delivery man'   => 'Cash received from driver',
    'Others'                            => 'Others',
    ...
    'Enter_from_weight'                     =>  'Enter from KG',
    'enter_to_weight'                       =>  'Enter to KG',
    'enter_price'                       =>  'Enter price',
    'Enter_from_km'   => 'Enter from km',
    'enter_to_km' => 'Enter to km',
    'enter_basic_price' => 'Enter basic price',
    'Enter_city' => 'Enter city',
    'Enter_email' => 'Enter email',
    'Enter_first_name' => 'Enter first name',
    'Enter_last_name'=>'Enter last name',
    'enter_company_name'=>'Enter company name ( Business )',
