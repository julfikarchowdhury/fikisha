        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                    <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('levels.create') }} {{ __('salary.title') }}</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="month"   name="month"   placeholder="yyyy-mm-dd"  class="form-control" value="{{old('month',date('Y-m'))}}" required>
                                    @error('date')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date"     name="date" data-parsley-trigger="change" placeholder="yyyy-mm-dd"  class="form-control" value="{{old('date',date('Y-m-d'))}}" required>
                                    @error('date')
                                    <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
                                </div>
