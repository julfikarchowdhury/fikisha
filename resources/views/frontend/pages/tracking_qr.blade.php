            ...
            <div class="col-lg-8 m-auto">
                <form action="{{ route('tracking.index') }}" method="GET">
                    ...
                    <div class="input-group mb-3 tracking-page tracking-form">
                        <input type="text" class="form-control" placeholder="{{ __('levels.enter_tracking_id') }}" name="tracking_id" value="{{ $parcel->tracking_id }}"  >
                        <div class="input-group-append">
                            <button type="submit" class="input-group-text bg-primary"  >{{ __('levels.track_now') }}</button>
                        </div>
                    </div>
                </form>
                <h3 class="font-size-1-5rem display-6 font-weight-bold text-center my-4">{{ __('levels.parcel_tracking_no') }}: <span class="text-primary"># {{ $parcel->tracking_id }}</span></h3>
            </div>
        </div>
        <div class="parcel-oprations">
            @if(!empty($parcel->tracking_id) && $parcel)
            ...
            <!-- cd-timeline -->
            @elseif(!empty($parcel->tracking_id) && !$parcel)
                <div class="row my-5">
