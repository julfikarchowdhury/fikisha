        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                    <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('merchant.create_merchant') }}</h4>
                </div>
                <div class="card-body">
                    <!-- <h2 class="pageheader-title">{{ __('merchant.create_merchant') }}</h2> -->
                    <form action="{{route('customer.store')}}"  method="POST" enctype="multipart/form-data" id="basicform">
                        @csrf
                        @if (isset($request->from_parcel) && !empty($request->from_parcel) )
                            <input type="hidden" name="from_parcel" value="from_parcel" />
                        @endif
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="first_name" type="text" name="first_name" data-parsley-trigger="change" placeholder="{{ __('placeholder.Enter_first_name') }}" autocomplete="off" class="form-control" value="{{old('first_name')}}" require>
                                    @error('first_name')
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="last_name" type="text" name="last_name" data-parsley-trigger="change" placeholder="{{ __('placeholder.Enter_last_name') }}" autocomplete="off" class="form-control" value="{{old('last_name')}}" require>
                                    @error('last_name')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        border-bottom-left-radius: 6px !important;">
                                            <span class="input-group-text" id="alternative_phone_number" style="border-top-left-radius: 6px !important;border-bottom-left-radius: 6px !important;">
                                                {{ settings()->country_code }}
                                            </span>
                                        </div>
                                        ...
                                        line-height: 1.5 !important;
                                        height: 39px !important;
                                        " name="alternative_phone_number" placeholder="{{ __('levels.enter_phone_number') }}" value="{{ old('alternative_phone_number') }}" id="alternative_phone_number" autocomplete="off">
                                    </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="minimum_reaches_amount">{{ __('parcel.minimum_reaches_amount') }}</label>
                                    <input id="minimum_reaches_amount" type="text" name="minimum_reaches_amount" data-parsley-trigger="change" placeholder="{{ __('parcel.Enter_minimum_reaches_amount') }}" autocomplete="off" class="form-control" value="{{old('minimum_reaches_amount')}}">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="discount">{{ __('parcel.discount') }} (%)</label>
                                    <input id="discount" type="text" name="discount" data-parsley-trigger="change" placeholder="{{ __('parcel.Enter_discount') }}" autocomplete="off" class="form-control" value="{{old('discount')}}">
                                    @error('discount')
                                    <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="hidden" id="pickup_lat" name="location_lat" value="{{ old('location_lat') }}">
                                <input type="hidden" id="pickup_long" name="location_long" value="{{ old('location_long') }}">
                                <div class="main-search-input-item location location-search">
                                    <div id="autocomplete-container" class="form-group random-search">
                                        <input id="autocomplete-input" type="text" name="location" class="recipe-search2 mb-2 form-control" value="{{ old('location') }}" placeholder="Location Here!" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="contract_document">{{ __('levels.contract_document') }}</label>
                            ...
                            <div class="col-md-6">
                                <div class="business">
                                    <div class="form-group">
                                        ...
                                        <textarea id="business_address" placeholder="{{ __('placeholder.Enter_business_address') }}" name="business_address" class="form-control">{{ old('business_address') }}</textarea>
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-7 col-12">
                                <h3 class="mb-2 mt-3" style="font-size: 18px; font-weight: 500;">{{ __('merchant.payment_date') }}</h3>

                                <div class="card" id="paymentDate">
                                    <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                                        <h3 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('menus.date') }}<span class="text-danger">*</span></h3>
                                    ...
                                    <div class="card-body p-0">
                                        <table id="paymentDate" class="table table-sm">
                                            <!-- <thead>
                                                <tr>
                        ...
                        <div class="row d-none">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        @foreach(\Config::get('wemaxconfig.cod_charges') as $key=>$charge)
...
<script>
    ...
    function addRow(){
        var tr = '<tr>'+
                    '<td><input type="date" name="payment_date[]" class="form-control" required /></td>'+
                    '<td class="text-center" style="width: 10%;"><button type="button" class="btn btn-danger btn-sm remove"><i class="fa fa-trash"></i></button></td>'+
                '</tr>';
