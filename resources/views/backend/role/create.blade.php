        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                    <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('role.create_role') }}</h4>
                </div>
                <div class="card-body">
                    <!-- <h2 class="pageheader-title">{{ __('role.create_role') }}</h2> -->
                    <form action="{{route('roles.store')}}" method="POST">
                        @csrf
                        @php($selectedPermissions = collect(old('permissions', [])))
                        <div class="row">
                                ...
                                <div class="card border role-meta-card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input id="name" type="text" name="name" data-parsley-trigger="change" placeholder="{{ __('placeholder.Enter_name') }}" autocomplete="off" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" required>
                                            @error('name')
