                    ...
                    <div class="row  ">
                        <div class="col-12 ">
                            <div class="d-flex justify-content-end mt-2 mt-md-0">
                                <a href="{{ route('merchant.invoice.pdf',[$invoice->merchant_id,$invoice->invoice_id]) }}" class="btn btn-secondary btn-sm mr-2" data-toggle="tooltip" data-placement="top" title="Add"><i class="fa fa-download"></i> PDF</a>
