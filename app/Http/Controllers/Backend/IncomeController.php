...
class IncomeController extends Controller
{
    protected $repo;
    protected $account;
    protected $parcel,$merchant,$deliveryman;
    ...
    public function create()
    {
        ...
        return view('backend.income.create',compact('accounts','accountHeads'));
    }
    ...
    public function edit($id)
    {
        ...
        $accountHeads = $this->repo->accountHeads();
        return view('backend.income.edit',compact('income','accounts','parcel','t_balance','deliveryman','accountHeads'));
    }
