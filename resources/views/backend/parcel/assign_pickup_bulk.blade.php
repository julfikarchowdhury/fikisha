          ...
          <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
            ...
            <form action="{{ route('parcel.assign-pickup-bulk',['page'=>$request->page]) }}" method="post">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-secondary" id="assign_pickup_btn">{{ __('levels.save') }}</button>
                    <button type="button"  class="btn btn-primary"   data-bs-dismiss="modal">{{ __('levels.cancel') }}</button>
                </div>
            </form>
        </div>
    </div>
