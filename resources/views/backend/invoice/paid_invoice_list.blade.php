        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                    <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('invoice.paid_invoice') }} {{ __('levels.list') }}</h4>
                </div>
                <div class="card-body">
                    <nav>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('merchant.invoice.pdf',[$invoice->merchant_id,$invoice->invoice_id]) }}" class="btn btn-sm btn-secondary mt-1"> <i class="fa fa-download"></i> PDF</a>
