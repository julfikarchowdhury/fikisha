        ...
        <div class="card card-height">
            ...
            <ul class="list-group m-2">
                ...
                <li class="list-group-item profile-list-group-item">
                    ...
                    <span class="float-right" id="totalCashCollection">{{settings()->currency}} {{ number_format($parcelsTotal['totalDeliveryIncome'] - $parcelsTotal['totalDeliveryExpense'],2) }}</span>
                </li>
                <li class="list-group-item profile-list-group-item">
