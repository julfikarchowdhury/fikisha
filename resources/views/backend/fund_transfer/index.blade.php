                ...
                <div class="card-header flex-column d-flex justify-content-between align-items-center gap-2 flex-wrap">
                    <div class="d-flex justify-content-between align-items-center gap-2 flex-wrap w-100">
                        <div class="d-flex align-items-center gap-3">
                            <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('fund_transfer.title') }}</h4>
                            <div class="d-lg-block">
                                <div class="d-flex align-item-center">
                                    ...
                                    <form action="{{ route('fund.transfer.specific.search') }}" class="d-flex  " style="width:100%">
                                        @csrf
                                        <input id="Psearch" class="form-control parcelSearchs group-input" value="{{ $request->search }}" name="search" type="text" placeholder="Search..">
                    ...
                    <div class="d-lg-none  mt-2">
                        <div class="d-flex align-item-center">
                            <form action="{{ route('fund.transfer.specific.search') }}" class="d-flex" style="width:100%">
                                @csrf
                                <input id="Psearch" class="form-control parcelSearchs fundTransferSearch group-input  " value="{{ $request->search }}" name="search" type="text" placeholder="Search..">
                                <button type="submit" class="btn btn-primary group-btn ml-0">Search</button>
                                @if (isset($search) && count($search) > 0)
                                <a href="{{ route('fund.transfer.search.filter.print',['ids'=>$search]) }}" target="_blank" class="btn btn-primary ml-2">{{ __('levels.print') }}</a>
                                @endif
