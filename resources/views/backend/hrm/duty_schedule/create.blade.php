...
@section('title')
    {{ __('parcel.duty_schedule') }} {{ __('levels.add') }}
@endsection
@section('maincontent')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                    <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('parcel.duty_schedule') }} {{ __('levels.create') }}</h4>
                </div>
                <div class="card-body">
                    <!-- <h2 class="pageheader-title">{{ __('parcel.duty_schedule') }} {{ __('levels.create') }}</h2> -->
                    <form action="{{route('hrm.duty.schedule.store')}}"  method="POST" enctype="multipart/form-data" id="basicform">
                        @csrf
                        <div class="row">
