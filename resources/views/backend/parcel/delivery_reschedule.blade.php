                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap deliveryman-search">
                            <select id="deliverymanreschedule" class="form-control deliverymanreschedule" data-province_id="" name="delivery_man_id" data-url="{{ route('parcel.deliveryman.search') }}" >
