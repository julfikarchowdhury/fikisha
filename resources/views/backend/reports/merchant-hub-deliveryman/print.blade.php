            ...
            <div class="invoice" id="printablediv">
                ...
                <div class="row mt-3" style="width:100%">
                    <div class="col-sm-12 " style="overflow: hidden">
                        ...
                        <span style="float: right">
                            <font style="font-weight: bold">Date :</font> {{ dateFormat(date('Y-m-d')) }}
                        </span>
                    </div>
                </div>
                <hr>
                <div class="row" style="margin-top: 20px">
                    <div class="col-sm-12 table-responsive">
                        ...
                        <div class="merchant">
                            ...
                            <div class="card mb-5">
                                <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                                    <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('reports.merchant_details') }}</h4>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="card mb-5">
                            <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                                <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('reports.hub_details') }}</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive" style="overflow-x:unset">
                                    <table class="table" style="width:100%">
                        ...
                        <div class="card mb-5">
                            <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                                <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('reports.deliveryman_details') }}</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive" style="overflow-x:unset">
                                    <table class="table   " style="width:100%">
