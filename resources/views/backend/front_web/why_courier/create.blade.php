        ...
        <div class="  col-sm-12 col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                    <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('levels.why_courier') }} {{ __('levels.add') }}</h4>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{route('why.courier.store')}}" method="POST" enctype="multipart/form-data" id="basicform">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="icon" type="text" name="icon" placeholder="Example: fa fa-check-square-o" autocomplete="off" class="form-control @error('icon') is-invalid @enderror" value="{{ old('icon') }}" require>
                                @error('icon')
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea id="content" name="content" placeholder="Enter content" autocomplete="off" class="form-control @error('content') is-invalid @enderror">{{old('content')}}</textarea>
                                @error('content')
                                <small class="text-danger mt-2">{{ $message }}</small>
                                @enderror
                            </div>
