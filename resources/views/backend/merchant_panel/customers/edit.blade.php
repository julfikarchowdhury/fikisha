        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('merchant-panel.customers.update',['id' => $customer->id]) }}" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="city_id" name="city_id" class="form-control select2">
                                        ...
                                        @foreach (\App\Models\Backend\City::all() as $city)
                                            @if (old('province_id',$customer->province_id) == $city->province_id)
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="account_type" id="account_type">
                                        ...
                                        <option value="1" @if (old('account_type',$customer->account_type) == 1) selected @endif>Individual</option>
                                        <option value="2" @if (old('account_type',$customer->account_type) == 2) selected @endif>Business</option>
                                    </select>
                                    @error('account_type')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="first_name" type="text" name="first_name" placeholder="{{ __('placeholder.Enter_first_name') }}" autocomplete="off" class="form-control @error('first_name') is-invalid @enderror" value="{{ old('first_name',$customer->first_name) }}">
                                    <input type="hidden" name="sender_id" value="{{ old('sender_id', $customer->sender_id) }}">
                                    @error('first_name')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="last_name" type="text" name="last_name" placeholder="{{ __('placeholder.Enter_last_name') }}" autocomplete="off" class="form-control @error('last_name') is-invalid @enderror" value="{{ old('last_name',$customer->last_name) }}">
                                    @error('last_name')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="phone_number" type="number" name="phone_number" placeholder="{{ __('placeholder.enter_phone_number') }}" autocomplete="off" class="form-control @error('phone_number') is-invalid @enderror" value="{{ old('phone_number',$customer->phone_number) }}">
                                    <input id="country_code" type="hidden" name="country_code" value="{{ old('country_code',$customer->country_code) }}">
                                    @error('phone_number')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="email" type="text" name="email" placeholder="{{ __('placeholder.enter_email') }}" autocomplete="off" class="form-control @error('email') is-invalid @enderror" value="{{ old('email',$customer->email) }}">
                                    @error('email')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input id="whatsapp_number" type="number" name="whatsapp_number" placeholder="{{ __('placeholder.enter_whatsapp_number') }}" autocomplete="off" class="form-control @error('email') is-invalid @enderror" value="{{ old('whatsapp_number',$customer->whatsapp_number) }}">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="address" id="address" class="form-control" rows="5" placeholder="{{ __('placeholder.Enter_address') }}" autocomplete="off">{{ $customer->address }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
