                        ...
                        <form action="{{ route('merchant-panel.parcel.update', $parcel) }}" method="POST" enctype="multipart/form-data" id="basicform">
                            ...
                            <div class="row">
                                <div class="form-group col-12 col-md-12">
                                    ...
                                    <textarea id="note" name="note" class="form-control" rows="3">{{ old('note', $parcel->note) }}</textarea>
                                    @error('note')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                ...
                                <input id="special_discount" type="hidden" name="special_discount" value="{{ old('special_discount', $parcel->special_discount) }}" required="">
