$(document).ready(function(){
    ...
    $(".parcel-id-delivery-man").click(function(){
        ...
        $("#deliverymanreschedule").attr("data-province_id", provinceId);
        $.ajax({
            type : 'POST',
    ...
    $( ".delivery_man_search" ).select2({
        ajax: {
            ...
            data: function (params) {
                return {
                    search: params.term,
                    province_id: $("#delivery_man_search").attr('data-province_id'),
                    searchQuery: true
                };
            },
            processResults: function (response) {
    ...
    $( ".deliveryManSearch" ).select2({
        ajax: {
            url: $("#deliveryManSearch").data('url'),
            type: "POST",
            dataType: 'json',
            delay: 250,
            data: function (params) {
                return {
                    search: params.term,
                    province_id: $("#deliveryManSearch").attr('data-province_id'),
                    searchQuery: true
                };
            },
            processResults: function (response) {
    ...
    $( ".delivery_man_second_province" ).select2({
        ajax: {
            url: $("#delivery_man_second_province").data('url'),
            type: "POST",
            dataType: 'json',
            delay: 250,
            data: function (params) {
                return {
                    search: params.term,
                    province_id: $("#delivery_man_second_province").attr('data-province_id'),
                    searchQuery: true
                };
            },
            processResults: function (response) {
    ...
    $( "#hub_search" ).select2({
        ajax: {
            ...
            data: function (params) {
                return {
                    search: params.term,
                    province_id: $("#hub_search").attr('data-province_id'),
                    searchQuery: true
                };
            },
            processResults: function (response) {
    ...
    $( "#hub_search2" ).select2({
        ajax: {
            ...
            data: function (params) {
                return {
                    search: params.term,
                    province_id: $("#hub_search2").attr('data-province_id'),
                    searchQuery: true
                };
            },
            processResults: function (response) {
    ...
    $( "#arrivedHub" ).select2({
        ajax: {
            ...
            data: function (params) {
                return {
                    search: params.term,
                    province_id: $("#arrivedHub").attr('data-province_id'),
                    searchQuery: true
                };
            },
            processResults: function (response) {
    ...
    $(".arrived-hub").click(function(){
        var parcelId = $(this).data('parcel');
        $(".modal_parcel_id").attr('value',parcelId);
        var provinceId = $(this).data('province_id');
        $("#arrivedHub").attr("data-province_id", provinceId);
    });

    $( "#arrivedToSendingHub" ).select2({
        ajax: {
            url: $("#arrivedToSendingHub").data('url'),
            type: "POST",
            dataType: 'json',
            delay: 250,
            data: function (params) {
                return {
                    search: params.term,
                    province_id: $("#arrivedToSendingHub").attr('data-province_id'),
                    searchQuery: true
                };
            },
            processResults: function (response) {
    ...
    $(".arrivedToSendingHub").click(function(){
        var parcelId = $(this).data('parcel');
        $(".modal_parcel_id").attr('value',parcelId);
        var provinceId = $(this).data('province_id');
        $("#arrivedToSendingHub").attr("data-province_id", provinceId);
    });

    $(".parcel-hub").click(function(){
        var parcelId = $(this).data('parcel');
        $(".modal_parcel_id").attr('value',parcelId);
        var provinceId = $(this).data('province_id');
        $("#hub_search").attr("data-province_id", provinceId);
        $("#hub_search2").attr("data-province_id", provinceId);
    });

    $(".parcel-delivery-man").click(function(){
        var parcelId = $(this).data('parcel');
        $(".modal_parcel_id").attr('value',parcelId);
        var provinceId = $(this).data('province_id');
        $("#delivery_man_search").attr("data-province_id", provinceId);
        $("#deliveryManSearch").attr("data-province_id", provinceId);
    });

    $(".parcel-delivery-second-province").click(function(){
        var parcelId = $(this).data('parcel');
        $(".modal_parcel_id").attr('value',parcelId);
        var provinceId = $(this).data('province_id');
        $("#delivery_man_second_province").attr("data-province_id", provinceId);
    });

    $(".parcelReturnAssignToMerchant").click(function(){
        var parcelId = $(this).data('parcel');
        $(".modal_parcel_id").attr('value',parcelId);
        var provinceId = $(this).data('province_id');
        $("#returnassigntomerchant").attr("data-province_id", provinceId);
    });

    $(".parcelReturnAssignToMerchantReschedule").click(function(){
        var parcelId = $(this).data('parcel');
        $(".modal_parcel_id").attr('value',parcelId);
        var provinceId = $(this).data('province_id');
        $("#returnassigntomerchantReschedule").attr("data-province_id", provinceId);
    });
    ...
    $( ".delivery_man_search_hub_multiple_parcel_hub" ).select2({
        dropdownParent:$('#transfer_to_hub_multiple_parcel'),
        ajax: {
            url: $("#delivery_man_search_hub_multiple_parcel_hub").data('url'),
            type: "POST",
            dataType: 'json',
            delay: 250,
            data: function (params) {
    ...
    $( ".delivery_man_search_hub_multiple_parcel_return" ).select2({
    ...
    $( "#deliverymanreschedule" ).select2({
        ajax: {
            ...
            data: function (params) {
                return {
                    search: params.term,
                    province_id: $("#deliverymanreschedule").attr('data-province_id'),
                    searchQuery: true
                };
            },
            processResults: function (response) {
    ...
    $("#returnassigntomerchant" ).select2({
        ajax: {
            ...
            data: function (params) {
                return {
                    search: params.term,
                    province_id: $("#returnassigntomerchant").attr('data-province_id'),
                    searchQuery: true
                };
            },
            processResults: function (response) {
    ...
    $( "#returnassigntomerchantReschedule" ).select2({
        ajax: {
            url: $("#returnassigntomerchantReschedule").data('url'),
            type: "POST",
            dataType: 'json',
            delay: 250,
            data: function (params) {
                return {
                    search: params.term,
                    province_id: $("#returnassigntomerchantReschedule").attr('data-province_id'),
                    searchQuery: true
                };
            },
            processResults: function (response) {
    ...
    // multiple parcel batch crate
    function showMultipleBatch(){
        if($('.common-key:checked').length > 0){
            $('.multipleBatch').show();
            var inputs   ='';
            $('.common-key:checked').each(function(){
            ...
            $('#batch_parcel_content').html(inputs);
        }else{
            $('.multipleBatch').hide();
            $('#tick-all').prop('checked', false);
            $('#batch_parcel_content').html('');
        }
    }
});
