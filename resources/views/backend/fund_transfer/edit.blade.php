        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                    <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('fund_transfer.edit_fund_transfer') }}</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="amount" step="any" name="amount" data-parsley-trigger="change" placeholder="{{ __('placeholder.Enter_Amount') }}" autocomplete="off" class="form-control" value="{{$fund_transfer->amount}}" require>
                                    @error('amount')
                                    <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
