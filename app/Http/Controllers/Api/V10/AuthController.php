...
class AuthController extends Controller
{
    ...
    public function deliveryManLogin(Request $request)
    {
        ...
        if ($request->filled('mobile')) {
            ...
            $deliveryman = User::where('mobile', $request->mobile)
        ...
        return $this->responseWithSuccess(__('auth.signin_msg'), [
            ...
            'user' => new DeliverymanUserResource(auth()->user()),
        ], 200);
    }
    ...
    public function updatePassword(Request $request)
    {
        ...
        if($result == 1){
            return $this->responseWithSuccess(__('auth.password_update'), ['error'=>0], 200);
        }
        elseif($result == 0){
            return $this->responseWithError(__('auth.password_old'), ['error'=>2], 422);
        }
        else
        {
            return $this->responseWithError(__('auth.error_msg'), [], 500);
