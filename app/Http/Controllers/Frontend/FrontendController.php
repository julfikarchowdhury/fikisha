...
class FrontendController extends Controller
{
    ...
    public function tracking(Request $request){
        ...
        if ($parcel && !empty($parcel->tracking_token)) {
            return redirect()->route('track.public', $parcel->tracking_token);
        }
    ...
    public function trackingQr($tracking_id)
    {
        $parcel         = $this->parcelRepo->parcelTrackingQr($tracking_id);
        if ($parcel && !empty($parcel->tracking_token)) {
            return redirect()->route('track.public', $parcel->tracking_token);
        }
        $parcelevents   = $this->parcelRepo->parcelEvents($parcel->id?? null);
        return view('frontend.pages.tracking_qr',compact('parcelevents','parcel'));
    }
