        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                    <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('levels.edit') }} {{ __('salary.title') }}</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="month"  name="month" data-parsley-trigger="change" placeholder="yyyy-mm-dd"  class="form-control" value="{{old('month',$singleSalary->month)}}" required>
                                    @error('month')
                                ...
                                <div class="form-group  "  >
                                    ...
                                    <div class="mt-2 active" id="user_salary">
                                        Salary: {{ $singleSalary->user->balance }}
                                    </div>
                                    @error('user_id')
                                    <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date"  name="date" data-parsley-trigger="change" placeholder="yyyy-mm-dd"  class="form-control" value="{{old('date',$singleSalary->date)}}" required>
                                    @error('date')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
                                </div>
