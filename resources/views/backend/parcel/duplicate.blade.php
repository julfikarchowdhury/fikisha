            ...
            <div class="col-md-12 col-lg-12 col-xl-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('parcel.clone-store') }}" method="POST" id="basicform">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6  col-lg-3 col-xl-4  col-sm-12 cbm-input-group">
                                                ...
                                                <div class="input-group ">
                                                    <input id="length" type="number" name="length" placeholder="{{ __('parcel.length') }}" autocomplete="off" class="form-control"
                                            ...
                                            <div class="col-md-6  col-lg-3 col-xl-4  col-sm-12 cbm-input-group mb-2">
                                                ...
                                                <div class="input-group ">
                                                    <input id="width" type="number" name="width" placeholder="{{ __('parcel.width') }}" autocomplete="off" class="form-control"
                                            ...
                                            <div class=" col-md-6  col-lg-3 col-xl-4  col-sm-12 cbm-input-group mb-2">
                                                ...
                                                <div class="input-group ">
                                                    <input id="height" type="number" name="height" placeholder="{{ __('parcel.height') }}" autocomplete="off" class="form-control"
