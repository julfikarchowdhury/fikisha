        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                    <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('parcel.parcel_bank') }} {{ __('levels.list') }}</h4>
                </div>
                <div class="card-body">
                        ...
                        <table class="table   " style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('parcel.from_location') }}</th>
                                    <th>{{ __('parcel.to_location') }}</th>  
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> 
                                        {{ __('parcel.country') }}: {{@$parcel->deliveryCharge->fromCountry->name}}<br/>
                                        {{ __('parcel.city') }}: {{@$parcel->deliveryCharge->fromCity->name}}<br/>
                                        {{ __('parcel.district') }}: {{@$parcel->deliveryCharge->fromDistrict->name }}<br/>
                                        {{ __('parcel.town') }}: {{ @$parcel->deliveryCharge->fromTown->name }}<br/>
                                        {{ __('parcel.portal_code') }}: {{ @$parcel->deliveryCharge->from_portal_code }}
                                    </td> 
                                    <td> 
                                        {{ __('parcel.country') }}: {{@$parcel->deliveryCharge->toCountry->name}}<br/>
                                        {{ __('parcel.city') }}: {{@$parcel->deliveryCharge->toCity->name}}<br/>
                                        {{ __('parcel.district') }}: {{ @$parcel->deliveryCharge->toDistrict->name }}<br/>
                                        {{ __('parcel.town') }}: {{ @$parcel->deliveryCharge->toTown->name }}<br/>
                                        {{ __('parcel.portal_code') }}: {{ @$parcel->deliveryCharge->to_portal_code }}
