                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <select name="merchant_id" id="merchant_id" class="form-control select2">
                                            <option value="">{{ __('levels.select') }} {{ __('merchant.title') }}
                                            </option>
                                            @foreach ($merchants as $merchant)
                                                <option value="{{ $merchant->id }}" @selected($merchant->id == $request->merchant_id)>
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex w-100">
                                        <input type="text" autocomplete="off" id="date" name="filter_date"
                                            class=" form-control  py-1  date_range_picker group-input"
