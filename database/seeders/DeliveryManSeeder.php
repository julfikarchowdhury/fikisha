...
class DeliveryManSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $deliveryUser->name                     = "Rider";
        $deliveryUser->mobile                   = "01912938004";
        $deliveryUser->email                    = "rider@fikisha.com";
        ...
        $deliveryMan->vehicle_type              = 'Van';
        $deliveryMan->province_id               = $deliveryUser->province_id;
        $deliveryMan->save();
    }
