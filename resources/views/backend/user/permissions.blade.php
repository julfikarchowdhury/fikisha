        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                    <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('user.title') }} {{ __('permissions.permissions') }}</h4>
                </div>
                <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left">
                                                    ...
                                                    <div class="row align-items-center justify-content-start permission-check-box pb-2 pt-2">
