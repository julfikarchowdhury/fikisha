...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        }elseif(request()->smsMethod == SmsSetup::EASYSENDSMS) {
            return [
                'easysendsms_username'         => ['required','string','max:1000'],
                'easysendsms_password'         => ['required','string','max:1000'],
                'easysendsms_from'             => ['required','string','max:1000'],
            ];
        }else {
            return [];
        }
