        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                    <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('reports.salary_reports') }}</h4>
                    @if($salaries->count() > 0)
                    ...
                    <div class="table-responsive"  >
                        <table class="table   " style="width:100%">
                            ...
                            @foreach($salaries as $key=>$salarys)
                                <thead>
                                    <tr class="bg-primary"> 
                                        <td colspan="7" class="text-white text-center font-weight-bold" style="color: white!important"> {{\Carbon\Carbon::createFromFormat('Y-m',$key)->format('M Y')}}</td>
