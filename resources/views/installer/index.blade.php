 ...
 <html lang="en">
    <head>
        ...
        <title>We Delivery - Parcel delivery courier management Logistics support cms</title>
    </head>
 <body>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="panel-heading text-center p-5">
                                                <h2>Welcome To We Delivery</h2>
                                                <h2>We Delivery - Parcel delivery courier management Logistics support CMS Laravel Script Installation</h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
