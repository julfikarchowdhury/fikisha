            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                        <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('parcel.duplicate') }}</h4>
                    </div>
                    <div class="card-body">
                        <!-- <h2 class="pageheader-title">{{ __('parcel.duplicate') }}</h2> -->
                        <form action="{{ route('merchant-parcel.clone-store') }}" method="POST" enctype="multipart/form-data" id="basicform">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <nav class="my-1">
                                                <div class="nav nav-pills location-tabs from_point_button" id="nav-tab" role="tablist">
                                                    ...
                                                    <button class="nav-link @if (old('from_point_type', $parcel->from_point_type) == 2) active @endif" data-type="2"  id="nav-profile-tab" data-bs-toggle="tab"
                                                        data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile"
                                                        aria-selected="false">
                                                        {{ settings()->name }} {{ __('parcel.drop_off_point') }}
                                                    </button>
                                                    <input type="hidden" id="from_point" value="{{ old('from_point_type', $parcel->from_point_type) }}" name="from_point_type">
                                                </div>
                                            </nav>
                                        </div>
                                        <div class="col-md-12 fromPointButton {{ old('from_point_type') == 2 ? 'd-block' : 'd-none' }}">
                                            <div class="form-group">
                                                <label for="from_hub_id">{{ __('parcel.hub') }} <span class="text-danger">*</span></label>
                                                <select style="width: 100%" id="from_hub_id" onchange="getFromHubInfo()" class="form-control select2" name="from_hub_id">
                                            ...
                                            <div class="form-group collapse" id="collapseExample">
                                                <div class="card card-body">
                                                    <p class="m-0 p-1"><strong>{{ __('parcel.hub') }}:</strong> <span id="from_hub_name"></span></p>
                                                    <p class="m-0 p-1"><strong>{{ __('parcel.phone_number') }}:</strong> <span id="from_hub_phone_number"></span></p>
                                                    <p class="m-0 p-1"><strong>{{ __('parcel.whatsapp_number') }}:</strong> <span id="hub_from_whatsapp_number"></span></p>
                                                    <p class="m-0 p-1"><strong>{{ __('levels.email') }}:</strong> <span id="from_hub_email"></span></p>
                                                    <p class="m-0 p-1"><strong>{{ __('levels.address') }}:</strong> <span id="from_hub_residential_address"></span></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 fromOnlyShowDoor {{ old('from_point_type') == 2 ? 'd-none' : 'd-block' }}">
                                            <div class="form-group">
                                                ...
                                                <select name="from_city_id" id="from_city_id" class="form-control select2" data-url="{{ route('city.wise.portal_code') }}" style="width: 100%">
                                                    ...
                                                    @foreach ($cities as $city)
                                                        @if (old('from_state_id', $parcel->from_state_id) == $city->province_id)
                                                            <option value="{{ $city->id }}" @selected(old('from_city_id', $parcel->from_city_id) == $city->id)>{{ $city->name }}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                                @error('from_city_id')
                                        ...
                                        <div class="col-sm-12 fromOnlyShowDoor {{ old('from_point_type') == 2 ? 'd-none' : 'd-block' }}">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="from_portal_code" id="from_portal_code"
                                                    ...
                                                    value="{{ old('from_portal_code',$parcel->from_portal_code ) }}" required="">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="hidden" id="from_account_type" name="from_account_type" value="{{ $merchant->account_type }}" />
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group merchant_info">
                                                <label for="shopID">{{ __('parcel.shop') }}</label>
                                                <select style="width: 100%"   class="form-control select2" name="shop_id" data-url="{{ route('parcel.merchant.shops') }}">
                                        ...
                                        <div class="col-md-12" id="company_name_field" style="display: none">
                                            <div class="form-group">
                                                ...
                                                <input id="company_name" type="text" name="company_name" placeholder="{{ __('placeholder.enter_company_name') }}" class="form-control" value="{{ old('company_name', $parcel->sender_company_name) }}">
                                                @error('company_name')
                                                    <small class="text-danger mt-2">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="first_name" type="text" name="first_name" placeholder="{{ __('placeholder.Enter_first_name') }}" class="form-control" value="{{ old('first_name', $parcel->sender_first_name) }}">
                                                @error('first_name')
                                                    <small class="text-danger mt-2">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="last_name" type="text" name="last_name" placeholder="{{ __('placeholder.Enter_last_name') }}" class="form-control" value="{{ old('last_name', $parcel->sender_last_name) }}">
                                                @error('last_name')
                                                    <small class="text-danger mt-2">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="pickup_phone" type="text" name="pickup_phone" placeholder="{{ __('levels.pickup') }} {{ __('levels.phone') }}" class="form-control" value="{{ old('pickup_phone', $parcel->pickup_phone) }}">
                                                @error('pickup_phone')
                                                    <small class="text-danger mt-2">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input placeholder="{{ __('levels.enter_email') }}" type="text" id="sender_email" name="sender_email" class="form-control" value="{{ old('sender_email', $parcel->sender_email) }}" />
                                                @error('sender_email')
                                                    <small class="text-danger mt-2">{{ $message }}</small>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <nav class="my-1">
                                                <div class="nav nav-pills location-tabs to_point_button" id="nav-tab" role="tablist">
                                                    ...
                                                    <button class="nav-link @if (old('to_point_type', $parcel->to_point_type) == 2) active @endif" data-type="2" id="nav-drop-off-point-tab" data-bs-toggle="tab"
                                                            data-bs-target="#nav-drop-off-point" type="button" role="tab" aria-controls="nav-drop-off-point"
                                                            aria-selected="false">
                                                            {{ settings()->name }} {{ __('parcel.drop_off_point') }}
                                                        </button>
                                                    <input type="hidden" id="to_point" value="{{ old('to_point_type', $parcel->to_point_type) }}"name="to_point_type">
                                                </div>
                                            </nav>
                                        </div>
                                        <div class="col-md-12 toPointButton {{ old('to_point_type') == 2 ? 'd-block' : 'd-none' }}">
                                            <div class="form-group">
                                                <label for="to_hub_id">{{ __('parcel.hub') }} <span class="text-danger">*</span></label>
                                                <select style="width: 100%" id="to_hub_id" class="form-control select2" onchange="getToHubInfo()" name="to_hub_id">
                                                    <option value=""> {{ __('menus.select') }} {{ __('parcel.hub') }}</option>
                                                </select>
                                                @error('to_hub_id')
                                                    <small class="text-danger mt-2">{{ $message }}</small>
                                            ...
                                            <div class="form-group collapse" id="collapseExample1">
                                                <div class="card card-body">
                                                    <p class="m-0 p-1"><strong>{{ __('parcel.hub') }}:</strong> <span id="to_hub_name"></span></p>
                                                    <p class="m-0 p-1"><strong>{{ __('parcel.phone_number') }}:</strong> <span id="to_hub_phone_number"></span></p>
                                                    <p class="m-0 p-1"><strong>{{ __('parcel.whatsapp_number') }}:</strong> <span id="to_whatsapp_number"></span></p>
                                                    <p class="m-0 p-1"><strong>{{ __('levels.email') }}:</strong> <span id="to_hub_email"></span></p>
                                                    <p class="m-0 p-1"><strong>{{ __('levels.address') }}:</strong> <span id="to_hub_residential_address"></span></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 toOnlyShowDoor {{ old('to_point_type') == 2 ? 'd-none' : 'd-block' }}">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-12 toOnlyShowDoor {{ old('to_point_type') == 2 ? 'd-none' : 'd-block' }}">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="to_portal_code" id="to_portal_code" placeholder="{{ __('parcel.portal_code') }}" class="form-control" value="{{ old('to_portal_code',$parcel->to_portal_code) }}" required="">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="border text-center p-2 mb-2 align-items-center">
                                                <h3 class="m-0 p-0">{{ __('parcel.recipient') }}</h3>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="to_account_type">Account Type<span class="text-danger">*</span></label>
                                                    <select class="form-control select2" name="to_account_type" id="to_account_type" style="width: 100%;">
                                                        <option value="">Select Account Type</option>
                                                        <option value="1" @if (old('to_account_type',$parcel->to_account_type) == 1) selected @endif>Individual</option>
                                                        <option value="2" @if (old('to_account_type',$parcel->to_account_type) == 2) selected @endif>Business</option>
                                                    </select>
                                            ...
                                            <div class="col-md-12 toCustomerType {{ old('from_account_type',$parcel->merchant->account_type) == 2 ? 'd-block' : 'd-none' }}">
                                                <div class="form-group">
                                                    ...
                                                    <select style="width: 100%" id="customer_id" name="customer_id" class="form-control select2" data-url="{{ route('parcel.customer.info') }}">
                                                        ...
                                                        @foreach($customers as $key => $customer)
                                                            @if(old('to_state_id',$parcel->to_state_id) == $customer->province_id)
                                                                <option value="{{ $customer->id }}" @selected(old('customer_id',$parcel->customer_id) == $customer->id)> {{ @$customer->name }}</option>
                                                            @endif
                                                        @endforeach
                                                    </select>
                                                    @error('customer_id')
                                            ...
                                            <div class="col-md-12 toAccountType {{ old('from_account_type',$parcel->merchant->account_type) == 2 ? 'd-none' : 'd-block' }}">
                                                <div class="form-group">
                                                    ...
                                                    <select style="width: 100%" id="to_merchant_id" name="to_merchant_id" class="form-control select2" data-url="{{ route('parcel.merchant.shops') }}">
                                                        ...
                                                        @foreach($merchants as $key => $to_merchant)
                                                            @if ($parcel->merchant_id == $to_merchant->id)
                                                                ...
                                                                @endphp
                                                            @endif
                                                            @if(old('to_state_id',$parcel->to_state_id) == $to_merchant->user->province_id && old('to_account_type',$parcel->to_account_type) == $to_merchant->account_type)
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="customer_first_name" type="text" name="customer_first_name" placeholder="{{ __('placeholder.Enter_first_name') }}" class="form-control" value="{{ old('customer_first_name', $parcel->customer_first_name) }}">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="customer_last_name" type="text" name="customer_last_name" placeholder="{{ __('placeholder.Enter_last_name') }}" class="form-control" value="{{ old('customer_last_name', $parcel->customer_last_name) }}">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger">*</span>
                                                    <input id="customer_phone" type="text" name="customer_phone" placeholder="{{ __('placeholder.enter_phone_number') }}" class="form-control" value="{{ old('customer_phone', $parcel->customer_phone) }}">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="receiver_email" type="text" name="receiver_email" placeholder="{{ __('parcel.receiver_email') }}" class="form-control" value="{{ old('receiver_email', $parcel->receiver_email) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="main-search-input-item location location-search">
                                            <div id="autocomplete-container" class="form-group random-search">
                                                <input id="autocomplete-inputs" type="text" name="pickup_location" class="recipe-search2 form-control" value="{{ old('pickup_location', $parcel->pickup_location) }}" placeholder="{{ __('parcel.pickup_location_heading') }}">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="drop_latitude" name="drop_latitude" value="{{ old('drop_latitude', $parcel->drop_latitude) }}" required="">
                                        <input type="hidden" id="drop_longitude" name="drop_longitude" value="{{ old('drop_longitude', $parcel->drop_longitude) }}" required="">
                                        <div class="main-search-input-item location location-search">
                                            <div id="autocomplete-container" class="form-group random-search">
                                                <input id="autocomplete" type="text" name="drop_location" class="form-control mb-2" placeholder="{{ __('parcel.delivery_location_heading') }}"
                                                value="{{ old('drop_location', $parcel->drop_location) }}" required="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cbm-box cbm-main mb-3 pt-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6  col-lg-3 col-xl-4  col-sm-12 cbm-input-group">
                                                <label for="length">{{ __('parcel.length') }} <span class="text-danger">*</span></label>
                                                <div class="input-group ">
                                                    <input id="length" type="number" name="length" placeholder="{{ __('parcel.length') }}" class="form-control"
                                                        value="{{ old('length', @$parcel->cbm_details['length']) }}">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text" id="basic-addon2">{{ __('parcel.cm') }}</span>
                                                    </div>
                                                </div>
                                                @error('length')
                                                    <small class="text-danger mt-2">{{ $message }}</small>
                                            ...
                                            <div class="col-md-6  col-lg-3 col-xl-4  col-sm-12 cbm-input-group mb-2">
                                                <label for="width">{{ __('parcel.width') }} <span class="text-danger">*</span></label>
                                                <div class="input-group ">
                                                    <input id="width" type="number" name="width" placeholder="{{ __('parcel.width') }}" class="form-control"
                                                        value="{{ old('width', @$parcel->cbm_details['width']) }}">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text" id="basic-addon2">{{ __('parcel.cm') }}</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class=" col-md-6  col-lg-3 col-xl-4  col-sm-12 cbm-input-group mb-2">
                                                <label for="height">{{ __('parcel.height') }} <span class="text-danger">*</span></label>
                                                <div class="input-group ">
                                                    <input id="height" type="number" name="height" placeholder="{{ __('parcel.height') }}" class="form-control"
                                                        value="{{ old('height', @$parcel->cbm_details['height']) }}">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text" id="basic-addon2">{{ __('parcel.cm') }}</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class=" col-md-6  col-lg-3 col-xl-4  col-sm-12 mb-2">
                                                ...
                                                <div class="form-group">
                                                    <input id="local_weight" type="number" step="any" name="local_weight" placeholder="{{ __('parcel.weight') }}"
                                                        class="form-control" value="{{ old('local_weight', @$parcel->cbm_details['local_weight']) }}">
                                                </div>
                                                @error('local_weight')
                                                    <small class="text-danger mt-2">{{ $message }}</small>
                                                @enderror
                                            ...
                                            <div class=" col-md-6  col-lg-3 col-xl-4  col-sm-12 mb-2">
                                                ...
                                                <div class="form-group">
                                                    <input id="quantity" type="number" name="quantity" placeholder="{{ __('parcel.quantity') }}" class="form-control"
                                            ...
                                            <div class="col-md-6 col-lg-3 col-xl-4 col-sm-12 parcelTypeId {{ old('package_type_id',@$parcel->cbm_details['package_type_id']) == 2 ? 'd-block' : 'd-none' }}">
                                                <div class="form-group">
                                                    <label for="main_category_id">{{ __('parcel.category') }} <span class="text-danger">*</span></label>
                                                    <select id="main_category_id" name="main_category_id" class="form-control w-100 select2" style="width: 100%;">
                                                        <option>{{ __('levels.select') }}{{ __('parcel.category') }}</option>
                                                        @foreach ($parcelCategories as $parcelcategory)
                                                            <option value="{{ $parcelcategory->id }}"
                                                                @selected(old('main_category_id',@$parcel->cbm_details['main_category_id']) == $parcelcategory->id)>{{ $parcelcategory->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            @if (SettingHelper('fragile_liquid_status') == \App\Enums\Status::ACTIVE)
                                                <div class="col-md-6  col-lg-3 col-xl-4 col-sm-12 mb-2 mt-2 parcelTypeId {{ old('package_type_id',@$parcel->cbm_details['package_type_id']) == 2 ? 'd-block' : 'd-none' }}">
                                                        ...
                                                        <div class="preview-block">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox"
                                                                    ...
                                                                    @if (isset($parcel->cbm_details['fragile_liquid_amount']) && $parcel->cbm_details['fragile_liquid_amount'] != null) checked @endif
                                                                    value="{{ @$parcel->cbm_details['fragile_liquid_amount'] }}">
                                            ...
                                            <div class="col-md-6 col-lg-3 col-xl-4 col-sm-12 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <input id="content_parcel" type="text" name="content_parcel" placeholder="{{ __('parcel.content_parcel') }}" class="form-control" value="{{ old('content_parcel',@$parcel->cbm_details['content_parcel']) }}">
                                                    @error('parcel_value')
                                                        <span class="text-danger mt-2">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12 cbm-input-group mb-2">
                                                <div class="d-flex align-items-end justify-content-center h-100">
                                                    ...
                                                    <input type="hidden" id="parcel_item_status" name="parcel_item_status" value="{{ old('parcel_item_status', 0) }}">
                                                    <input type="hidden" id="shipping_fee_status" name="shipping_fee_status" value="{{ old('shipping_fee_status', 0) }}">
                            ...
                            <div class="row">
                                ...
                                <input id="special_discount" type="hidden" name="special_discount" class="form-control" value="{{ old('special_discount', $parcel->special_discount) }}" required="">
