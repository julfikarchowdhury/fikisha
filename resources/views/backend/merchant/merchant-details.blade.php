...
<ul class="list-group">
    <li class="list-group-item profile-list-group-item">
        ...
        <span class="float-right">{{ $singleMerchant->business_name ?: 'N/A' }}</span>
    </li>
    ...
    <li class="list-group-item profile-list-group-item">
        ...
        <span class="float-right">{{ $singleMerchant->discount }}</span>
    </li>
    ...
    <li class="list-group-item profile-list-group-item justify-content-center">
        <span class="float-left font-weight-bold">{{ __('levels.nid') }} (Front side)</span>
        <span class="float-right profile-list-group-item-addresss"><img src="{{ $singleMerchant->nid }}" width="100px" /></span>
    </li>
    <li class="list-group-item profile-list-group-item justify-content-center">
        <span class="float-left font-weight-bold">{{ __('levels.nid') }} (Back side)</span>
        <span class="float-right profile-list-group-item-addresss"><img src="{{ $singleMerchant->nid_back }}" width="100px" /></span>
    </li>
    ...
    <li class="list-group-item profile-list-group-item">
        ...
        <span class="float-right profile-list-group-item-addresss">{{ $singleMerchant->address ?: $singleMerchant->user->address }}</span>
    </li>
