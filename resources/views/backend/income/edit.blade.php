        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-2 flex-wrap">
                    <h4 class="mb-0" style="font-size: 18px; font-weight: 500;">{{ __('income.edit_income') }}</h4>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group amount_divs">
                                    ...
                                    <div class="form-control-wrap">
                                        <input type="number" class="form-control cash-collection" id="amount" value="{{ $income->amount }}" name="amount" placeholder="{{ __('placeholder.Enter_Amount') }}" step="any"  required>
                                        @error('amount')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                        @enderror
