                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group  ">
                                ...
                                <div class="form-control-wrap ">
                                    <select id="transfer_hub" class="form-control  " name="hub_id"  data-url="{{ route('parcel.transferHub') }}" >
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="form-control-wrap deliveryman-search">
                                    <select id="delivery_man_search_hub_multiple_parcel_hub" class="form-control delivery_man_search_hub_multiple_parcel_hub" name="delivery_man_id" data-url="{{ route('parcel.deliveryman.search') }}" >
